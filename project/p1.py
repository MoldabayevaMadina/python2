...
def finish_booking_vip(window_show_vip, e2):
    vip_num = e2.get()
    ...
    cursor.execute(query, values)
    query9 = 'SELECT price FROM inform WHERE table_number = %s'
    value9 = (vip_num,)
...
def menu(window_show_vip, combo4): 
    ...
    Button(window_menu, text = 'finish\nbooking', font = ("Arial", 10), background = "white", command = lambda: finish_booking_vip(window_menu, combo4)).place(x = 420, y = 200) 
